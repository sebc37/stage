...
#K = [k0*lmb**i for i in range(nb_shell)]
...
# transformer en tensor les différents arrays des datasets pour le train
...
class initials_variables_data(torch.utils.data.Dataset):
    def __init__(self,X_ic,nbr_initial_t,k_min,k_max):
        ...
        #self.grille = self.grille.flatten(start_dim=0,end_dim=1)
...
# initial_train_dataset.tensor_data.cuda(0)
# boundary_train_dataset.tensor_data_bc.cuda(0)
# colocation_dataset.tensor_data_colocation.cuda(0)
# grid_dataset.grille.cuda(0)




learning_rate,nbr_iteration,w_1,w_2,w3,w_4 = 0.005,10,1,1,1,1
...
# plt.figure()
# plt.plot(square_error[:,0],label='Square error u1')
# plt.plot(square_error[:,2],label='Square error u2')
# plt.plot(square_error[:,4],label='Square error u4')
# plt.plot(square_error[:,6],label='Square error u6')
# plt.plot(square_error[:,8],label='Square error u8')
# plt.xlabel('Time')
