...
#define fs 99999.99 // for data saving
#define time 1.0e1  // for data saving (you'll get Npts = time*fs per simulation)
...
#define DATA_FILE "data_test.dat"            // where to save the main output (shells) (from DO_SAVE )
