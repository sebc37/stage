...
PATH = r"/home/s26calme/Documents/code_stage/Donnees/GOY_modele/Parametre_Ewen/"
...
class grid_data(torch.utils.data.Dataset): # créer la grille sur laquelle on veut inferer U(k,t) sous la forme (k,t)
...
# for idx,data in enumerate(Dataloader_ic):
#     print(data)

# for idx,data in enumerate(Dataloader_bc):
#     print(data)

# for idx,data in enumerate(Dataloader_cl):
#     print(data)
...
learning_rate,nbr_iteration,w_1,w_2,w3,w_4 = 0.001,1,1,1,1,1
